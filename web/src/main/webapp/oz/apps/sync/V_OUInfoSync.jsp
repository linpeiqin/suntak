...
<body class="oz-body" data-name="<oz:messageSource code="oz.mdu.organize.ouinfo"/>">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ldap/ouInfoSyncAction" searchButton="normal">
			<oz:tbSeperator/>
	...
	<div id="page-center" class="oz-page-center">
		...
		<div id="page-center-grid" class="oz-page-center-grid">
			<oz:grid action="ldap/ouInfoSyncAction" sortName="ouInfo.orderNo" sortOrder="asc" fit="true" pagination="true" excel="true">
				<oz:column field="id" checkbox="true"/>
				<oz:column field="ouName" title="oz.mdu.organize.ouinfo.fields.name" width="240" sortable="false" formatter="oz_DefaultFormatter"/>
                <oz:column field="adName" title="oz.cmpn.ldap.sync.ouinfo.fields.adname" width="240" sortable="false"/>
                <oz:column field="mode" title="oz.cmpn.ldap.sync.fields.mode" width="100" sortable="false" formatter="ouInfoTypeFormatter"/>
                <oz:column field="lastUpdate" title="oz.cmpn.ldap.sync.fields.lastupdate" width="100" sortable="false"/>
			</oz:grid>
		</div>		
	</div>
</body>
...
function executeSync(){
    ...
    OZ.Msg.confirm(
            ...
            function(){
                $.getJSON(
                        contextPath + "/ldap/ouInfoSyncAction.do?action=sync&timeStamp=" + new Date().getTime(),
                        {ids:ids.join(";")},
                        function(json){
                            if(json.result == true){
                                OZ.Msg.info('同步操作成功！');
