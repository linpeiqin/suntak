			...
			<div class="oz-form-fields">
				<table cellpadding="0">
					...
					<tr> 
						...
						<td>
							<html:radio property="adSSO" styleId="adSSO" value="0" disabled="true"/><oz:messageSource code="oz.enable"/>
							<html:radio property="adSSO" styleId="adSSO" value="1" disabled="true"/><oz:messageSource code="oz.disable"/>
						</td>
					...
					<tr id="TR_DC">
						...
						<td class="oz-property">
							<span class="oz-form-fields-span"><bean:write name="winADConfigForm" property="domainController"/></span>
						</td>
						<td class="oz-guideline">
						</td>
					</tr>
					<tr id="TR_WINS"> 
						...
						<td class="oz-property">
							<span class="oz-form-fields-span"><bean:write name="winADConfigForm" property="wins"/></span>
						</td>
						<td class="oz-guideline">
						</td>
					</tr>
					<tr id="TR_DN">
						...
						<td class="oz-property">
							<span class="oz-form-fields-span"><bean:write name="winADConfigForm" property="domainName"/></span>
						</td>
						<td class="oz-guideline">
						</td>
					</tr>
					<tr id="TR_UN">
						...
						<td class="oz-property">
							<span class="oz-form-fields-span"><bean:write name="winADConfigForm" property="userName"/></span>
						</td>
						<td class="oz-guideline">
						</td>
					</tr>
					<tr id="TR_UP">
						...
						<td class="oz-property">
							<span class="oz-form-fields-span"><bean:write name="winADConfigForm" property="userPwd"/></span>
						</td>
						<td class="oz-guideline">
						</td>
					</tr>
