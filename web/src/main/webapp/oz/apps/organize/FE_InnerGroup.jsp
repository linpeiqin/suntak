...
<body class="oz-body" data-name="<oz:messageSource code="oz.mdu.organize.group"/>">
	...
	<div id="page-center" class="oz-page-form">
		<html:form action="organize/groupAction.do" styleId="ozForm" styleClass="oz-form">
			<div class="oz-form-title" style="height:24px;"><oz:messageSource code="oz.mdu.organize.group"/></div>
			<div style="text-align:left; margin-top:0px;color:red;font-weight:bold">
				<div id="DIV_INNERFLAG">&nbsp;&nbsp;&nbsp;&nbsp;(<oz:messageSource code="oz.mdu.organize.group.inner.group"/>)</div>
			</div>
			<div class="oz-form-fields" style="margin:0px;">
				<table cellpadding="2" cellspacing="0" class="oz-form-bordertable" style="width:800px;table-layout:fixed;border-top-width:0px">
					...
					<tr class="oz-form-tr">
						...
						<td class="oz-property" colspan="3">
							<span class="oz-form-fields-span"><bean:write name="groupForm" property="memos"/></span>
						</td>
					</tr>
				</table>			
			</div>
					...
					<div data-tab-panel='{"id":"tab_03","title":"<oz:messageSource code="oz.mdu.organize.group.tabs.managers"/>","border":false,"fit":true,"iconCls":"oz-icon-tab"}'>
						<table cellpadding="3" cellspacing="3" style="width:99%;margin:2px 2px 2px 2px;">
							...
							<tr> 
								...
								<td style="text-align:center; vertical-align:middle;">
									<input id="btnAddManager" type="button" class="oz-form-button" value=" <oz:messageSource code="oz.add"/> > " onclick="OZ.SELECT.appendSelected('canSelectGroupManagers', 'selectedGroupManagers', true)"/><br /><br /><br />
									<input id="btnDelManager" type="button" class="oz-form-button" value=" < <oz:messageSource code="oz.delete"/> " onclick="OZ.SELECT.appendSelected('selectedGroupManagers', 'canSelectGroupManagers', true)"/><br /><br /><br />
									<input id="btnClearManagers" type="button" class="oz-form-button" value=" << <oz:messageSource code="oz.clearall"/> " onclick="OZ.SELECT.appendAll('selectedGroupManagers', 'canSelectGroupManagers', true)"/>
								</td>
								<td>
