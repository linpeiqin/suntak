...
<body class="oz-body" data-name="<oz:messageSource code="oz.mdu.organize.ouinfo"/>">
	...
	<div id="page-center" class="oz-page-form">
		<html:form action="organize/ouInfoAction.do" styleId="ozForm" styleClass="oz-form">
			<div class="oz-form-title"><oz:messageSource code="oz.mdu.organize.ouinfo.department"/></div>
				...
				<table cellpadding="2" cellspacing="0" class="oz-form-bordertable" style="width:800px;table-layout:fixed;border-top-width:0px">
					...
					<tr class="oz-form-tr">
						...
						<td class="oz-property" colspan="5">
							<html:text property="parent.fullName" styleId="parentFullName" styleClass="oz-form-zdField" readonly="true" style="width:645px"/>
							<oz:linkButton onclick="OZ.Organize.selectOUInfo(onAfterSelectOUInfo)" text="oz.btn.select"></oz:linkButton>
						</td>
					</tr>
					<tr class="oz-form-tr"> 
						<td class="oz-form-label-r"><oz:messageSource code="oz.mdu.organize.ouinfo.fields.department.name"/>：</td>
						<td class="oz-property" colspan="3">
							<html:text property="name" styleClass="oz-form-btField"/>
						</td>
						<td class="oz-form-label-r"><oz:messageSource code="oz.mdu.organize.ouinfo.fields.department.abbrname"/>：</td>
					...
					<tr class="oz-form-tr"> 
						...
						<td class="oz-form-label-r">
							<div class="ou-type">
								<oz:messageSource code="oz.mdu.organize.ouinfo.fields.departmenttype"/>：
							</span>
						</td>
						<td class="oz-property">
							<div class="ou-type">
					...
					<tr class="oz-form-tr"> 
						...
						<td class="oz-form-label-r"><oz:messageSource code="oz.mdu.organize.ouinfo.fields.istemporary.department"/>：</td>
						<td>
...
function onAfterSelectOUInfo(result){
	if(result.id == $("#id").val()){
