...
<div id="page" class="oz-page">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="component/attachmentAction">
			...
			<oz:tbSeperator/>
			<oz:tbButton id="btnDownload" text="下载文件" icon="oz-icon-1128" onclick="onBtnDownloadFile_Clicked()"></oz:tbButton>
		</oz:toolbar>
	</div>
...
function onBtnDownloadFile_Clicked(){
	var strUrl = contextPath + '/component/attachmentAction.do?action=getFile&id=' + _contentId;
	strUrl += "&timeStamp=" + new Date().getTime();
