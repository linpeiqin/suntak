...
Timepicker.prototype = {
    init: function()
    {
        ...
        this._colonPos  = -1;
        this._visible   = false;
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden" style="width: 150px; display: none; position: absolute;"></div>');
        this._generateHtml();
    },
    ...
    show: function (input)
    {
        ...
        this.tpDiv.css("zIndex",dpDiv.css("zIndex"));
    },
    ...
    _generateHtml: function ()
    {
        ...
        html += '<tr><th>时</th><th>分</th><th>秒</th></tr>';
