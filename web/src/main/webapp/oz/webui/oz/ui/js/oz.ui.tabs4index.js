(function($) {
	...
	OZ.widget("OZ.tab.Tabs",{
		...
		_render: function() {
			...
			this.body =$(this.element.attr("data-body-ref"));
			this.tbct = $(this.element.attr("data-tab-ref"));
			
			this.tbct.addClass('oz-tabs-header').html("<div class='oz-tabs-scroller-left'></div><div class='oz-tabs-scroller-right'></div><div class='oz-tabs-strip-wrap'><ul class='oz-tabs-strip oz-tabs-strip-top'><li class='oz-tabs-edge'/><div class='oz-clear'/></ul></div><div class='oz-tabs-strip-spacer'/>");
			
			if(o.plain){
				this.tbct.addClass("oz-tabs-header-plain");
			}
			...
			this.scrollLeft = $(".oz-tabs-scroller-left",this.tbct).disableSelection().hoverClass("oz-tabs-scroller-left-over").bind("click."+this.$type,$.proxy(this,"_onScrollLeft"));
			this.scrollRight = $(".oz-tabs-scroller-right",this.tbct).disableSelection().hoverClass("oz-tabs-scroller-right-over").bind("click."+this.$type,$.proxy(this,"_onScrollRight"));
			
			$(window).bind('resize.'+this.$type, $.proxy(this.resize,this));
		},
		_init:function(){
		...
		_createTab:function(config){
			...
			var iconHtml = "";
			if(config.iconCls){
				iconHtml = '<i class="'+config.iconCls+'"></i> ';
			}
			var tabHtml =['<li class="oz-tabs-tab"><a class="oz-tabs-text" href="javascript:void(0)" onclick="return false;">',	iconHtml,config.title,'<a class="oz-tabs-strip-close" onclick="return false;"></a>','</a></li>'].join("");
