		...
		var _create_tooltip = function($element) {
            ...
            if (tooltip_info.window_resized || tooltip_info.window_scrolled) {
                ...
                var tooltip_left =  plugin.settings.position == 'left' ? tooltip_info.element_left - tooltip_info.tooltip_width + tooltip_info.arrow_width :
                    ...
                    tooltip_top =   tooltip_info.element_top - tooltip_info.tooltip_height - $("#page-top").height() + $("#page-center").scrollTop(),                    
                    ...
                    if($("#ozApFormTabTriggers").length > 0){
                    	tooltip_top += $("#ozApFormTabTriggers").height();
                    }
                ...
                if (tooltip_top < vertical_scroll) {
                    ...
                    tooltip_top = tooltip_info.element_top + tooltip_info.element_height - $("#page-top").height() + $("#page-center").scrollTop();
