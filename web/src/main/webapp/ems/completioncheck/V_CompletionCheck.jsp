...
<body class="oz-body" data-name="工程完工验收报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/completionCheckAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/completionCheckAction" sortName="number" fit="true"  excel="true" >
...
<oz:js jsSrc="/ems/completioncheck/js/ems.completioncheck.V.js"/>
