...
<div id="page-top" class="oz-page-top">
    <oz:toolbar action="ems/completionCheckAction">
        <oz:tbSeperator/>
        <oz:tbButton id="btnBack"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSave"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSubmitEBS" icon="oz-icon oz-icon-0121" onclick="onSubmitEBS(this,'completionCheck')" text="同步EBS"/>
        <oz:tbSeperator/>
  		<oz:tbButton id="btnSubmitOA" icon="oz-icon oz-icon-0121" onclick="onSubmitOA('EProjectFinish_99','completionCheck','formmain_0153')" text="同步OA"/>
  		<oz:tbSeperator/>
    </oz:toolbar>
</div>
            ...
            <div class="ems-form-content">
                ...
                <div class="ems-form-body">
                    <table class="ems-table-head" >
                        <tr>
                            <td width="70%">编号：<span id="numberSpan"><bean:write  name="completionCheckForm" property="number" ></bean:write></span></td>
...
<oz:js jsSrc="/ems/completioncheck/js/ems.completioncheck.FE.js"/>
