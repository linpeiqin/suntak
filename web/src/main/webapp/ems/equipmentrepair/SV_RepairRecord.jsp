...
<body class="oz-body" data-name="设备维修记录表">
		...
		<div id="page-center" class="oz-page-center">
			<oz:grid action="ems/repairRecordAction" sortName="maintenaceState" fit="true"  excel="true" >
...
<script type="text/javascript">
    oz_grid_config.url = "<oz:contextPath/>/ems/repairRecordAction.do?action=page&viewType=sview";
</script>
</html>