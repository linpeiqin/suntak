					...
					<div class="oz-form-fields2">
						<table class="oz-form-bordertable" style="width: 99%">
							...
							<tr class="oz-form-tr">
								...
								<td class="oz-property">
									<span id="appearanceSummary"></span>
...
<oz:js jsSrc="/ems/equipmentrepair/js/ems.faultdesc.DF.js" />
