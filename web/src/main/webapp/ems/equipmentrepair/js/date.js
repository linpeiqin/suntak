...
------  ----------  --------------------------------------------------------------
  ...
  l      一  		A full textual representation of the day of the week
...
Date.getFormatCode = function(character) {
    switch (character) {
    case "d":
        return "OZ.String.leftPad(this.getDate(), 2, '0') + ";
    case "D":
    ...
    case "m":
        return "OZ.String.leftPad(this.getMonth() + 1, 2, '0') + ";
    case "M":
    ...
    case "h":
        return "OZ.String.leftPad((this.getHours() %12) ? this.getHours() % 12 : 12, 2, '0') + ";
    case "H":
        return "OZ.String.leftPad(this.getHours(), 2, '0') + ";
    case "i":
        return "OZ.String.leftPad(this.getMinutes(), 2, '0') + ";
    case "s":
        return "OZ.String.leftPad(this.getSeconds(), 2, '0') + ";
    case "O":
    ...
    default:
        return "'" + OZ.String.escape(character) + "' + ";
    }
};
    ...
    case "O":
        return {g:1,
            c:[
                ...
                "    (sn + OZ.String.leftPad(hr, 2, 0) + OZ.String.leftPad(mn, 2, 0)) : null;\n"
            ].join(""),
            s:"([+\-]\\d{4})"};
    case "T":
        return {g:0,
...
Date.prototype.getGMTOffset = function() {
    return (this.getTimezoneOffset() > 0 ? "-" : "+")
        + OZ.String.leftPad(Math.abs(Math.floor(this.getTimezoneOffset() / 60)), 2, "0")
        + OZ.String.leftPad(this.getTimezoneOffset() % 60, 2, "0");
};
...
Date.prototype.getWeekOfYear = function() {
    ...
    return OZ.String.leftPad(((now - then) / 7) + 1, 2, "0");
};
