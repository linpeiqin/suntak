...
<body class="oz-body oz-form-tabs"  style="margin-left: 0px;width:100%;height:200px;border: 0px solid #99BBE8"  data-name="添加配件">
<table  id="partsGrid"></table>
</body>
<oz:js />
<oz:js jsSrc="/ems/common/js/common.util.js" />
<oz:js jsSrc="/ems/equipmentrepair/js/ems.partreplace.F.js" />
