...
<div id="page-center" class="oz-page-center">
    <oz:grid action="ems/maintainAction" sortName="id" fit="true"  excel="true" singleSelect="true">
        ...
        <oz:column field="equipmentDetails.equipmentName" title="设备名称" width="500" sortable="true" formatter="oz_DefaultFormatter" />
        ...
        <oz:column field="maintainLevelName" title="保养级别" width="80" sortable="true" formatter="oz_DefaultFormatter" />
        <oz:column field="executDate" title="执行日期" width="130" sortable="true" formatter="renderpublisherDate2" />
...
<script type="text/javascript">
    oz_grid_config.url = "<oz:contextPath/>/ems/maintainAction.do?action=page&viewType=sview";
</script>
</html>
