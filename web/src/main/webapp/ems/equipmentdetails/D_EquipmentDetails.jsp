...
<body class="oz-body" data-name="设备详细信息表">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/equipmentDetailsAction" sortName="equipmentNo" fit="true"  excel="true" sortOrder="asc">
			<oz:column field="id" checkbox="false"  title="" width="27"  />
			<oz:column field="useD" title="使用部门" width="80" sortable="true" />
			<oz:column field="installationLocation" title="安装地点" width="90" sortable="true" />
			<oz:column field="equipmentName" title="设备名称" width="200" sortable="true" />
			<oz:column field="equipmentNo" title="设备编号" width="110" sortable="true" />
...
<script type="text/javascript">
	oz_grid_config.url = "<oz:contextPath/>/ems/equipmentDetailsAction.do?action=page&type=2";
	function ozDlgOkFn() {
