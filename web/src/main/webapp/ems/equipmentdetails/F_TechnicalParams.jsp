...
<body class="oz-body" data-name="扩展技术参数">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/technicalParamsAction" defaultTB="readForm">
		</oz:toolbar>
	</div>
	<div id="page-center" class="oz-page-form">
		<html:form action="ems/technicalParamsAction" styleId="ozForm"	styleClass="oz-form">
						...
						<table class="oz-form-bordertable" style="width: 97%;">
							...
							<tr class="oz-form-tr">
								...
								<td class="oz-property">
									<bean:write name="technicalParamsForm" property="technicalParam"/>
								</td>
							</tr>
							<tr class="oz-form-tr">
								<td class="oz-form-label-l">值</td>
								<td class="oz-property">
									<bean:write name="technicalParamsForm" property="paramValue"/>
								</td>
							</tr>
						</table>
					</div>
