...
<body class="oz-body" data-name="固定资产入厂报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/intoFactoryAndCheckAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/intoFactoryAndCheckAction" sortName="number" fit="true"  excel="true" >
...
<oz:js jsSrc="/ems/intofactoryandcheck/js/ems.intofactoryandcheck.V.js"/>
