...
<div id="page-top" class="oz-page-top">
    <oz:toolbar action="ems/intoFactoryAndCheckAction">
        <oz:tbSeperator/>
        <oz:tbButton id="btnSave"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSubmitEBS" icon="oz-icon oz-icon-0121" onclick="onSubmitEBS(this,'intoFactoryAndCheck')" text="同步EBS"/>
  		<oz:tbSeperator/>
  		<oz:tbButton id="btnSubmitOA" icon="oz-icon oz-icon-0121" onclick="onSubmitOA('EIntoFactoryAndCheck_99','intoFactoryAndCheck','formmain_0169')" text="同步OA"/>
        <oz:tbSeperator/>
            ...
            <div class="ems-form-content">
                ...
                <div class="ems-form-body">
                    <table class="ems-table-head" >
                        <tr>
                            <td width="50%">编号：<span id="numberSpan"><bean:write  name="intoFactoryAndCheckForm" property="number" ></bean:write></span></td>
                            <td width="50%">合同编号：<bean:write name="intoFactoryAndCheckForm" property="contractNumber" /> <html:hidden property="contractNumber" styleId="contractNumber"  /></td>
                        </tr>
                    </table>
                    <table class="ems-form-table">
                        ...
                        <tr>
                            ...
                            <td>代 理 商</td>
                            <td>
                                <html:text styleClass="oz-form-field oz-form-btField" property="agent" styleId="agent"  style="width:100%" onclick="selectAgent(this,afterAgentChange)" ></html:text>
                            ...
                            <td colspan="3" style="padding: 0;border: 0">
                                <table class="ems-table-sub1">
                                    ...
                                    <tr>
                                        ...
                                        <td>原 值<span>(<bean:write name="intoFactoryAndCheckForm" property="tax"></bean:write><bean:write name="intoFactoryAndCheckForm" property="currency"></bean:write>)</span></td>
...
<oz:js jsSrc="/ems/intofactoryandcheck/js/ems.intofactoryandcheck.FE.js"/>
