...
<div id="page-top" class="oz-page-top">
    <oz:toolbar action="ems/renewalAndCheckAction">
        <oz:tbSeperator/>
        <oz:tbButton id="btnSave"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSubmitEBS" icon="oz-icon oz-icon-0121" onclick="onSubmitEBS(this,'renewalAndCheck')" text="同步EBS"/>
    	<oz:tbSeperator/>
  		<oz:tbButton id="btnSubmitOA" icon="oz-icon oz-icon-0121" onclick="onSubmitOA('EUpdate_99','renewalAndCheck','formmain_0158')" text="同步OA"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSelectEQ" icon="oz-icon oz-icon-0121" onclick="onSelectEQ(this,4)" text="选择待更新、改造设备"/>
        <oz:tbSeperator/>
    </oz:toolbar>
</div>
            ...
            <div class="ems-form-content">
                ...
                <div class="ems-form-body">
                    <table class="ems-table-head" >
                        <tr>
                            <td width="50%">编号：<span id="numberSpan"><bean:write  name="renewalAndCheckForm" property="number" ></bean:write></span></td>
                            <td width="50%">合同编号：<bean:write name="renewalAndCheckForm"  property="contractNumber" /> <html:hidden property="contractNumber" styleId="contractNumber"  /></td>
                        </tr>
                    </table>
                    <table class="ems-form-table">
                        ...
                        <tr>
                            <td>更新改造项目</td>
                            <td>
                                <html:text property="origin" styleId="origin" styleClass="oz-form-btField" style="width:100%"/>
                            </td>
                            <td>改造商</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <html:textarea styleClass="oz-form-btfield" property="faUpdateContent" styleId="faUpdateContent"></html:textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>改造完成时间</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <bean:write name="renewalAndCheckForm" property="usefulLife"></bean:write>
                            ...
                            <td>
                                ...
                                <bean:write name="renewalAndCheckForm" property="canUseLife"></bean:write>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="padding: 0;border: 0">
                                <table class="ems-table-sub1">
                                    ...
                                    <tr>
                                        <td>净  值<span>(<bean:write name="renewalAndCheckForm" property="currency"></bean:write>)</span>
                                        <html:hidden property="currency" styleId="currency"/></td>
                                        <td>
...
<oz:js jsSrc="/ems/renewalandcheck/js/ems.renewalandcheck.FE.js"/>
