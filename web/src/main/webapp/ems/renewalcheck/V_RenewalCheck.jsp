...
<body class="oz-body" data-name="固定资产更新改造验收报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/renewalCheckAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/renewalCheckAction" sortName="number" fit="true"  excel="true" >
...
<oz:js jsSrc="/ems/renewalcheck/js/ems.renewalcheck.V.js"/>
