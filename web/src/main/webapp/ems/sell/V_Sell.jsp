...
<body class="oz-body" data-name="固定资产出售报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/sellAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/sellAction" sortName="number" fit="true"  excel="true" >
...
<oz:js jsSrc="/ems/sell/js/ems.sell.V.js"/>
