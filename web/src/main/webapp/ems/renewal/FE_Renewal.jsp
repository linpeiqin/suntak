...
<div id="page-top" class="oz-page-top">
    <oz:toolbar action="ems/renewalAction">
        <oz:tbSeperator/>
        <oz:tbButton id="btnSave"/>
        <oz:tbSeperator/>
        <oz:tbButton id="btnSubmitEBS" icon="oz-icon oz-icon-0121" onclick="onSubmitEBS(this,'renewal')" text="同步EBS"/>
    	<oz:tbSeperator/>
  		<oz:tbButton id="btnSubmitOA" icon="oz-icon oz-icon-0121" onclick="onSubmitOA('EUpdate_99','renewal','formmain_0158')" text="同步OA"/>
        <oz:tbSeperator/>
            ...
            <div class="ems-form-content">
                ...
                <div class="ems-form-body">
                    <table class="ems-table-head" >
                        <tr>
                            <td width="50%">编号：<span id="numberSpan"><bean:write  name="renewalForm" property="number" ></bean:write></span></td>
                            <td width="50%">合同编号：
                                <bean:write name="renewalForm"  property="contractNumber" /> <html:hidden property="contractNumber" styleId="contractNumber"  /></td>
                        </tr>
                    </table>
                    <table class="ems-form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <bean:write name="renewalForm" property="usefulLife"></bean:write>
                            ...
                            <td>
                                ...
                                <bean:write name="renewalForm" property="canUseLife"></bean:write>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="padding: 0;border: 0">
                                <table class="ems-table-sub1">
                                    ...
                                    <tr>
                                        <td>净  值<span>(<bean:write name="renewalForm" property="currency"></bean:write>)</span>
...
<oz:js jsSrc="/ems/renewal/js/ems.renewal.FE.js"/>
