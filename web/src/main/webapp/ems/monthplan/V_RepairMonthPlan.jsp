...
<body class="oz-body" data-name="保养月计划表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/repairMonthPlanAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/repairMonthPlanAction" sortName="id" fit="true"  excel="true" sortOrder="asc">
			<oz:column field="id" checkbox="true" title="" width="27" />
			<oz:column field="planMonth" title="计划月" width="100" sortable="true" formatter="oz_DefaultFormatter" />
			...
			<oz:column field="plannerName" title="计划者" width="160" sortable="true" formatter="oz_DefaultFormatter" />
		</oz:grid>
	</div>
</body>
<oz:js/>
...
<oz:js jsSrc="/ems/monthplan/js/ems.monthplan.V.js"/>
