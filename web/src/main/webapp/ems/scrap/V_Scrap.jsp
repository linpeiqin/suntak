...
<body class="oz-body" data-name="固定资产报废报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/scrapAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/scrapAction" sortName="number" fit="true"  excel="true" >
...
<oz:js jsSrc="/ems/scrap/js/ems.scrap.V.js"/>
