...
<body class="oz-body" data-name="固定资产内部转移报告表">
	<div id="page-top" class="oz-page-top">
		<oz:toolbar action="ems/internalTransferAction" searchButton="none">
	...
	<div id="page-center" class="oz-page-center">
		<oz:grid action="ems/internalTransferAction" sortName="number" fit="true"  excel="true" >
			...
			<oz:column field="specificationModel" title="规 格 型 号" width="160" sortable="true" formatter="oz_DefaultFormatter" />
...
<oz:js jsSrc="/ems/internaltransfer/js/ems.internaltransfer.V.js"/>
